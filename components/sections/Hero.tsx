...
//         background: "radial-gradient(ellipse 55% 45% at 50% 40%, rgba(200,169,126,0.08) 0%, transparent 68%)",
//       }} />

//       {/* Solana-purple accent blob */}
//       <div aria-hidden style={{
...
//       }} />
//       <div aria-hidden style={{
//         position: "absolute", bottom: "20%", left: "6%", width: 220, height: 220,
//         borderRadius: "50%", pointerEvents: "none",
//         background: "radial-gradient(circle, rgba(20,241,149,0.05) 0%, transparent 70%)",
//         filter: "blur(40px)",
//       }} />

//       {/* Eyebrow — compact, close to headline */}
//       <div style={{
...
//           background: "#14f195",
//           boxShadow: "0 0 6px rgba(20,241,149,0.8)",
//           display: "inline-block",
//           animation: "pulse 2s ease-in-out infinite",
//         }} />
//         <span style={{ color: "#14f195", fontSize: "0.75rem", letterSpacing: "0.06em", fontWeight: 500 }}>
...
//         fontSize: "clamp(2.75rem, 9vw, 6.5rem)", fontWeight: 400,
//         lineHeight: 1.06, letterSpacing: "-0.03em",
//         color: "var(--foreground)", maxWidth: "14ch",
//         marginBottom: "1.1rem",
//         animation: "slideUp 0.65s ease forwards",
//         animationDelay: "0.08s", opacity: 0,
//       }}>
//         AI agents that own{" "}
//         <em style={{ color: "var(--primary)", fontStyle: "italic" }}>their own wallets.</em>
//       </h1>

//       {/* Subheadline */}
//       <p style={{
//         color: "var(--muted-foreground)",
//         fontSize: "clamp(0.95rem, 1.8vw, 1.1rem)", lineHeight: 1.75,
...
//         textAlign: "left", maxWidth: "440px", width: "100%",
//         animation: "slideUp 0.65s ease forwards",
...
//           ))}
//           <span style={{ marginLeft: 6, fontSize: "0.68rem", color: "var(--border)", letterSpacing: "0.04em" }}>
//             AgentWallet.ts
//           </span>
//         </div>
//         {/* Code lines */}
//         <div style={{ lineHeight: 1.8 }}>
//           <span style={{ color: "#94a3b8" }}>{"// autonomous — no human needed"}</span>
//           <br />
//           <span style={{ color: "#7dd3fc" }}>const</span>
//           {" "}<span style={{ color: "var(--foreground)" }}>{"{ signature }"}</span>
//           {" "}<span style={{ color: "#7dd3fc" }}>=</span>
//           {" "}<span style={{ color: "#86efac" }}>await</span>
//           {" "}<span style={{ color: "var(--foreground)" }}>wallet</span>
...
//           <br />
//           <span style={{ color: "#7dd3fc" }}>const</span>
//           {" "}<span style={{ color: "var(--foreground)" }}>decision</span>
//           {" "}<span style={{ color: "#7dd3fc" }}>=</span>
//           {" "}<span style={{ color: "#86efac" }}>await</span>
...
//           padding: "0.8rem 1.75rem", background: "var(--primary)",
...
//       <style>{`
//         @keyframes pulse {
//           0%, 100% { opacity: 1; box-shadow: 0 0 6px rgba(20,241,149,0.8); }
//           50%       { opacity: 0.6; box-shadow: 0 0 12px rgba(20,241,149,0.4); }
//         }
//         @keyframes fadeIn {
//           from { opacity: 0; }
//           to   { opacity: 1; }
